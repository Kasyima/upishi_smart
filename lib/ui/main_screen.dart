...
import 'package:recipes/network/local_foods/firestore_helper.dart';
...
import 'package:recipes/ui/authentication/user_dao.dart';
        ...
        items: [
          ...
          BottomNavigationBarItem(
            icon: Icon(
              ...
              color: _selectedIndex == 3 ? green : Colors.grey,
              semanticLabel: 'Custom Foods',
            ),
            label: 'Custom Foods',
          ),
        ],
